...
const translations = {
  en: {
    ...
    "discussion.empty.description": "Be the first to start a discussion by visiting a cave page and leaving a comment.",
    "discussion.browse": "Browse Caves",
    "discussion.comments": "comments",
    "discussion.comment": "comment",
    "discussion.view": "View full discussion",
    "discussion.section": "Discussion",
    "discussion.placeholder": "Share your knowledge or ask a question about this cave...",
    ...
    "discussion.no.comments": "No comments yet. Be the first to share your thoughts!",
    ...
    "sources.standards.text": "For a cave to be included in our rankings, we require:",
    "sources.standards.item1": "Documented survey data with clear methodology",
    "sources.standards.item2": "Verification by recognized speleological organizations when possible",
    "sources.standards.item3": "Cross-referencing with multiple sources when available",
    "sources.standards.item4": "Clear documentation of measurement techniques and standards",
    ...
    "sources.primary.item1": "International Union of Speleology (UIS) publications",
    "sources.primary.item2": "National speleological society reports",
    "sources.primary.item3": "Peer-reviewed research papers",
    "sources.primary.item4": "Expedition reports from recognized caving organizations",
    ...
    "tribute.contributions.item1": "Maintained the world's most comprehensive cave rankings database for over 45 years",
    "tribute.contributions.item2": "Created the definitive map of the Friars Hole Cave System",
    ...
    "tribute.contributions.item5": "Received the prestigious Karst Award in March 2022 from the Karst Waters Institute",
    "tribute.contributions.item6": "Mentored numerous young cavers and researchers",
  ...
  es: {
    ...
    "discussion.placeholder": "Comparte tu conocimiento o haz una pregunta sobre esta cueva...",
    "discussion.posting": "Publicando como",
    "discussion.post": "Publicar Comentario",
    "discussion.posting.action": "Publicando...",
    "discussion.signin": "Inicia sesión para unirte a la discusión sobre esta cueva.",
    "discussion.signin.action": "Iniciar Sesión",
    "discussion.loading": "Cargando comentarios...",
    "discussion.count": "Comentarios",
    "discussion.no.comments": "Aún no hay comentarios. ¡Sé el primero en compartir tus pensamientos!",
    ...
    "sources.standards.text": "Para que una cueva sea incluida en nuestras clasificaciones, requerimos:",
    "sources.standards.item1": "Datos de estudio documentados con metodología clara",
    "sources.standards.item2": "Verificación por organizaciones espeleológicas reconocidas cuando sea posible",
    "sources.standards.item3": "Referencias cruzadas con múltiples fuentes cuando estén disponibles",
    "sources.standards.item4": "Documentación clara de técnicas y estándares de medición",
    ...
    "sources.primary.item1": "Publicaciones de la Unión Internacional de Espeleología (UIS)",
    ...
    "sources.primary.item4": "Informes de expediciones de organizaciones espeleológicas reconocidas",
    ...
    "tribute.contributions.item2": "Creó el mapa definitivo del Sistema de Cuevas Friars Hole",
    "tribute.contributions.item3":
    ...
    "tribute.contributions.item6": "Mentorizó a numerosos jóvenes espeleólogos e investigadores",
    "tribute.contributions.item7":
  ...
  fr: {
    ...
    "discussion.section": "Discussion",
    "discussion.placeholder": "Partagez vos connaissances ou posez une question sur cette grotte...",
    ...
    "discussion.signin": "Connectez-vous pour rejoindre la discussion sur cette grotte.",
    "discussion.signin.action": "Se Connecter",
    "discussion.loading": "Chargement des commentaires...",
    "discussion.count": "Commentaires",
    "discussion.no.comments": "Pas encore de commentaires. Soyez le premier à partager vos pensées !",
    ...
    "sources.standards.text": "Pour qu'une grotte soit incluse dans nos classements, nous exigeons :",
    "sources.standards.item1": "Des données d'étude documentées avec une méthodologie claire",
    "sources.standards.item2": "Vérification par des organisations spéléologiques reconnues lorsque possible",
    "sources.standards.item3": "Recoupement avec plusieurs sources lorsque disponibles",
    "sources.standards.item4": "Documentation claire des techniques et normes de mesure",
    ...
    "sources.primary.item1": "Publications de l'Union Internationale de Spéléologie (UIS)",
    ...
    "sources.primary.item4": "Rapports d'expédition d'organisations spéléologiques reconnues",
    ...
    "tribute.contributions.item2": "A créé la carte définitive du système de grottes Friars Hole",
    "tribute.contributions.item3":
    ...
    "tribute.contributions.item5": "A reçu le prestigieux Prix Karst en mars 2022 du Karst Waters Institute",
    "tribute.contributions.item6": "A encadré de nombreux jeunes spéléologues et chercheurs",
    "tribute.contributions.item7":

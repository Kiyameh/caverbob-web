    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-6">
          ...
          <p>
            We collect information when you register on our site, submit cave
            data, participate in discussion forums, or fill out a form. The
            information collected may include your name, email address, and
            profile information if you choose to register.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul>
            ...
            <li>
              To process submissions and maintain the cave rankings database
            </li>
            <li>
              To send periodic emails regarding your submissions or other
              website features
            </li>
          </ul>
        </section>

      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-6">
          ...
          <ul>
            ...
            <li>
              ...
              users who have logged into the site.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            expire when you close your browser. They enable the website to
            recognize you as you navigate between pages.
          </p>
          <p>
            <strong>Persistent Cookies:</strong> These remain on your device
            until they expire or you delete them. They enable the website to
            remember your preferences for the next time you visit.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            "Preferences" menu of your browser. You can also configure your
            browser to reject all cookies, but this may affect the functionality
            of many websites, including ours.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            be posted on this page and, where appropriate, notified to you when
